...
const (
	Query_Params_FullMethodName   = "/dastchain.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/dastchain.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/dastchain.tokenfactory.Query/DenomAll"
)
