...
func init() {
	...
	md_BuyOrderBook = File_dastchain_dex_buy_order_book_proto.Messages().ByName("BuyOrderBook")
...
func (x *BuyOrderBook) slowProtoReflect() protoreflect.Message {
	mi := &file_dastchain_dex_buy_order_book_proto_msgTypes[0]
...
func (x *fastReflection_BuyOrderBook) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "dastchain.dex.BuyOrderBook.index":
		return x.Index != ""
	case "dastchain.dex.BuyOrderBook.amountDenom":
		return x.AmountDenom != ""
	case "dastchain.dex.BuyOrderBook.priceDenom":
		return x.PriceDenom != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dastchain.dex.BuyOrderBook"))
		}
		panic(fmt.Errorf("message dastchain.dex.BuyOrderBook does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message dastchain.dex.BuyOrderBook does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "dastchain.dex.BuyOrderBook.index":
		panic(fmt.Errorf("field index of message dastchain.dex.BuyOrderBook is not mutable"))
	case "dastchain.dex.BuyOrderBook.amountDenom":
		panic(fmt.Errorf("field amountDenom of message dastchain.dex.BuyOrderBook is not mutable"))
	case "dastchain.dex.BuyOrderBook.priceDenom":
		panic(fmt.Errorf("field priceDenom of message dastchain.dex.BuyOrderBook is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: dastchain.dex.BuyOrderBook"))
		}
...
func (x *fastReflection_BuyOrderBook) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in dastchain.dex.BuyOrderBook", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: dastchain/dex/buy_order_book.proto
...
func (*BuyOrderBook) Descriptor() ([]byte, []int) {
	return file_dastchain_dex_buy_order_book_proto_rawDescGZIP(), []int{0}
}
...
var File_dastchain_dex_buy_order_book_proto protoreflect.FileDescriptor

var file_dastchain_dex_buy_order_book_proto_rawDesc = []byte{
	,
	...
	0x69, 0x6e, 0x2f, 0x64, 0x65, 0x78, 0xa2, 0x02, 0x03, 0x44, 0x44, 0x58, 0xaa, 0x02, 0x0d, 0x44,
	0x61, 0x73, 0x74, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x44, 0x65, 0x78, 0xca, 0x02, 0x0d, 0x44,
	0x61, 0x73, 0x74, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5c, 0x44, 0x65, 0x78, 0xe2, 0x02, 0x19, 0x44,
	0x61, 0x73, 0x74, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5c, 0x44, 0x65, 0x78, 0x5c, 0x47, 0x50, 0x42,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0e, 0x44, 0x61, 0x73, 0x74, 0x63,
	0x68, 0x61, 0x69, 0x6e, 0x3a, 0x3a, 0x44, 0x65, 0x78, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_dastchain_dex_buy_order_book_proto_rawDescOnce sync.Once
	file_dastchain_dex_buy_order_book_proto_rawDescData = file_dastchain_dex_buy_order_book_proto_rawDesc
)

func file_dastchain_dex_buy_order_book_proto_rawDescGZIP() []byte {
	file_dastchain_dex_buy_order_book_proto_rawDescOnce.Do(func() {
		file_dastchain_dex_buy_order_book_proto_rawDescData = protoimpl.X.CompressGZIP(file_dastchain_dex_buy_order_book_proto_rawDescData)
	})
	return file_dastchain_dex_buy_order_book_proto_rawDescData
}

var file_dastchain_dex_buy_order_book_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dastchain_dex_buy_order_book_proto_goTypes = []interface{}{
	(*BuyOrderBook)(nil), // 0: dastchain.dex.BuyOrderBook
}
var file_dastchain_dex_buy_order_book_proto_depIdxs = []int32{
...
func init() { file_dastchain_dex_buy_order_book_proto_init() }
func file_dastchain_dex_buy_order_book_proto_init() {
	if File_dastchain_dex_buy_order_book_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_dastchain_dex_buy_order_book_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dastchain_dex_buy_order_book_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dastchain_dex_buy_order_book_proto_goTypes,
		DependencyIndexes: file_dastchain_dex_buy_order_book_proto_depIdxs,
		MessageInfos:      file_dastchain_dex_buy_order_book_proto_msgTypes,
	}.Build()
	File_dastchain_dex_buy_order_book_proto = out.File
	file_dastchain_dex_buy_order_book_proto_rawDesc = nil
	file_dastchain_dex_buy_order_book_proto_goTypes = nil
	file_dastchain_dex_buy_order_book_proto_depIdxs = nil
}
