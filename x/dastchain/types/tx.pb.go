...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_06ec27d35298dd25, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_06ec27d35298dd25, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "dastchain.dastchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "dastchain.dastchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("dastchain/dastchain/tx.proto", fileDescriptor_06ec27d35298dd25) }

var fileDescriptor_06ec27d35298dd25 = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0x49, 0x2c, 0x2e,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x32, 0x33, 0xb7, 0x58, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/dastchain.dastchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dastchain.dastchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "dastchain.dastchain.Msg",
	...
	Metadata: "dastchain/dastchain/tx.proto",
}
